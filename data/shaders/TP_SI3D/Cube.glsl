...
#ifdef USE_NORMAL
    vertex_normal = transpose(inverse(mat3(viewMatrix * modelMatrix[gl_InstanceID]))) * normal;
#endif

#if defined USE_LIGHT || !defined USE_NORMAL
    vertex_position= vec3(viewMatrix * modelMatrix[gl_InstanceID] * vec4(position, 1));
#endif
